...
<head>
    ...
    <style>
        ...
        * { box-sizing:border-box; } body { margin:0; color:var(--ink); background:linear-gradient(135deg,#f8efe6 0%,#fffdf8 48%,#e5f1ef 100%); font:16px/1.5 Georgia,serif; }
        ...
        form { max-width:620px; background:rgba(255,255,255,.84); border:1px solid var(--line); padding:26px; border-radius:18px; } label { display:block; margin:14px 0 6px; font-family:system-ui,sans-serif; font-size:14px; font-weight:600; } input,select { width:100%; border:1px solid #cfc3b7; border-radius:9px; padding:11px; font:inherit; background:#fff; } .camera-settings { margin-top:16px; padding:16px; border:1px dashed #b9cfc8; border-radius:12px; background:#f3faf7; } .camera-settings input[type=range] { padding:0; } .form-actions { margin-top:22px; display:flex; gap:10px; }
